 ...
 *         <element name="in_inv_id" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "save_invoice")
public class SaveInvoice {
    ...
    @XmlElement(name = "in_inv_id")
    protected int inInvId;
    ...
    /**
     * Gets the value of the inInvId property.
     * 
     */
    public int getInInvId() {
        return inInvId;
    }

    /**
     * Sets the value of the inInvId property.
     * 
     */
    public void setInInvId(int value) {
        this.inInvId = value;
    }
